...
@section('title', 'Step 4 - Assessments')
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                <a href="{{ route('student.step', 3) }}" class="btn btn-outline-secondary"><i
                        class="bi bi-arrow-left me-2"></i>Back</a>
                <a href="{{ route('student.step', 5) }}" class="btn btn-orange">Continue <i
