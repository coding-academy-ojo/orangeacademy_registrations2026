...
@section('title', 'Step 6 - Review & Submit')
@section('content')
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-4 pb-3 border-bottom">
                ...
                @foreach($user->documents as $doc)
                    <span class="badge bg-dark me-1 mb-1">{{ str_replace('_', ' ', ucfirst($doc->type)) }}</span>
                @endforeach
            ...
            <div class="mb-4 pb-3 border-bottom">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <a href="{{ route('student.step', 4) }}" class="btn btn-sm btn-outline-orange">View</a>
                </div>
            ...
            <form method="POST" action="{{ route('student.submit') }}">
                ...
                <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                    <a href="{{ route('student.step', 5) }}" class="btn btn-outline-secondary"><i
