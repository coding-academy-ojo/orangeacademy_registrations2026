...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="dropdown">
            <button class="btn btn-sm btn-outline-primary dropdown-toggle" type="button" id="pdfExportDropdown"
                data-bs-toggle="dropdown" aria-expanded="false" style="font-weight: 600;">
                <i class="bi bi-file-earmark-pdf me-1"></i> <span data-en="View Report"
                    data-ar="عرض التقرير">View Report</span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0" aria-labelledby="pdfExportDropdown">
                ...
                @foreach(\App\Models\Academy::all() as $academy)
                    <li>
                        <a class="dropdown-item" href="{{ route('admin.export-pdf', ['academy' => $academy->id]) }}" target="_blank">
                            <i class="bi bi-building me-2 text-muted"></i> {{ $academy->name }}
                        </a>
                    </li>
                @endforeach
        ...
        <div class="col-lg-4">
            <div class="card chart-card h-100">
                <div class="card-header bg-white py-3">
                    <h6 class="fw-bold mb-0 small" data-en="Students by Gender" data-ar="الطلاب حسب الجنس"><i
                            class="bi bi-gender-ambiguous me-2 text-muted"></i>Students by Gender</h6>
                </div>
            ...
            <div class="card chart-card h-100">
                <div class="card-header bg-white py-3">
                    <h6 class="fw-bold mb-0 small"><i class="bi bi-map me-2 text-muted"></i> <span
                            ...
                            data-ar="انقر على منطقة مميزة لعرض التفاصيل">Click a highlighted region to see details</span>
                    </h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-5">
            <div id="mapInfoPanel">
                <div class="text-center py-5" id="mapDefaultMessage" style="margin:auto;">
                    ...
                    <h6 class="fw-bold text-secondary" data-en="Select a Region" data-ar="اختر منطقة">Select a Region</h6>
                    <p class="text-muted small mb-0 px-3"
                        ...
                        Click on an orange-highlighted region on the map to view all academy details in that area.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- ═══════════════════════════════════════════════════════ --}}
    {{-- SECTION 4B: Demographics Charts (Education, Country, City) --}}
    {{-- ═══════════════════════════════════════════════════════ --}}
    <div class="section-title"><i class="bi bi-pie-chart"></i> <span data-en="Demographics Overview" data-ar="نظرة عامة على التركيبة السكانية">Demographics Overview</span></div>
    <div class="row g-4 mb-4">
        {{-- Education Level Chart --}}
        <div class="col-lg-6">
            <div class="card chart-card h-100">
                <div class="card-header bg-white py-3">
                    <h6 class="fw-bold mb-0" data-en="Education Level" data-ar="المستوى التعليمي"><i class="bi bi-mortarboard me-2 text-muted"></i>Education Level</h6>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-6">
            <div class="card chart-card h-100">
                <div class="card-header bg-white py-3">
                    <h6 class="fw-bold mb-0" data-en="University" data-ar="الجامعة"><i class="bi bi-bank me-2 text-muted"></i>University</h6>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                @foreach($recent_enrollments as $e)
                                    <tr>
                                        <td class="small ps-3">{{ $e->user->profile->first_name_en ?? $e->user->email }}</td>
    ...
    <div class="row g-3 mb-3">
        <div class="col-6 col-lg-3">
            <div class="card chart-card text-center h-100" style="border-left: 4px solid #ff7900;">
                <div class="card-body py-3">
                    <div class="text-muted small mb-1"><i class="bi bi-lightning-charge"></i> Today's Activity</div>
                    <div class="fw-bold" style="font-size:2rem;color:#ff7900;">{{ $todayActivityCount }}</div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card chart-card text-center h-100" style="border-left: 4px solid #dc3545;">
                <div class="card-body py-3">
                    ...
                    <div class="fw-bold" style="font-size:2rem;color:#dc3545;">{{ $progressCounts['not_started'] }}</div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card chart-card text-center h-100" style="border-left: 4px solid #ffc107;">
                <div class="card-body py-3">
                    <div class="text-muted small mb-1"><i class="bi bi-hourglass-split"></i> In Progress</div>
                    <div class="fw-bold" style="font-size:2rem;color:#ffc107;">{{ $progressCounts['in_progress'] }}</div>
        ...
        <div class="col-6 col-lg-3">
            <div class="card chart-card text-center h-100" style="border-left: 4px solid #28a745;">
                <div class="card-body py-3">
                    ...
                    <div class="fw-bold" style="font-size:2rem;color:#28a745;">{{ $progressCounts['completed'] }}</div>
    ...
    <div class="card chart-card mb-4">
        <div class="card-header bg-white d-flex justify-content-between align-items-center py-3">
            <h6 class="fw-bold mb-0 small"><i class="bi bi-clock-history me-2 text-muted"></i>Recent Activity Log</h6>
        ...
        <div class="card-body p-0">
            ...
            @else
                <div class="text-center py-5 text-muted">
                    ...
                    <p class="mt-2 small">No activities logged yet.<br>Activities will appear here as users interact with the
                        system.</p>
                </div>
            @endif
        </div>
